...
class BaseServiceApi extends AbstractSoapClientBase {
    protected $wsdlRelativePath = '/Services/API/IAppointment_1.wsdl';
    protected $wsdlHostRelativePath = '/Services/API/IAppointment.svc?wsdl';
    ...
    public function __construct(array $wsdlOptions = [])
    {
        ...
        $wsdlOverride[AbstractSoapClientBase::WSDL_CLASSMAP] = \Larapress\PayamGostar\Services\PayamGostar\Soap\Appointment\ClassMap::get();
