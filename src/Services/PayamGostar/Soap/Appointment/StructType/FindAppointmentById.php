...
/**
 * This class stands for FindAppointmentById StructType
 * @subpackage Structs
 */
class FindAppointmentById extends AbstractStructBase
{
    /**
     * The username
    ...
    /**
     * Constructor method for FindAppointmentById
     * @uses FindAppointmentById::setUsername()
     * @uses FindAppointmentById::setPassword()
     * @uses FindAppointmentById::setAppointmentId()
     ...
     * @param string $username
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Appointment\StructType\FindAppointmentById
     */
