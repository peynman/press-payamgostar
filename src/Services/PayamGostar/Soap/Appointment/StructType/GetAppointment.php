...
/**
 * This class stands for GetAppointment StructType
 * @subpackage Structs
 */
class GetAppointment extends AbstractStructBase
{
    /**
     * The userName
     ...
     * @uses GetAppointment::setUserName()
     * @uses GetAppointment::setPassword()
     * @uses GetAppointment::setCrmId()
     * @param string $userName
     * @param string $password
     * @param string $crmId
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $crmId = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Appointment\StructType\GetAppointment
     */
