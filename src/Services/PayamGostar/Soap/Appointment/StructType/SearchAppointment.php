...
/**
 * This class stands for SearchAppointment StructType
 * @subpackage Structs
 */
class SearchAppointment extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchAppointment
     * @uses SearchAppointment::setUserName()
     * @uses SearchAppointment::setPassword()
     * @uses SearchAppointment::setQuery()
     * @uses SearchAppointment::setTypeKey()
     * @param string $userName
     * @param string $password
     * @param string $query
     * @param string $typeKey
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $query = null, ?string $typeKey = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Appointment\StructType\SearchAppointment
     */
