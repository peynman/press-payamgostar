...
/**
 * This class stands for SendAppointmentNotifications StructType
 * @subpackage Structs
 */
class SendAppointmentNotifications extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SendAppointmentNotifications
     * @uses SendAppointmentNotifications::setUserName()
     * @uses SendAppointmentNotifications::setPassword()
     * @uses SendAppointmentNotifications::setAppointmentId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Appointment\StructType\SendAppointmentNotifications
     */
