...
class BaseCrmObjectInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo|null
     */
    protected ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo $ExtendedProperties = null;
    /**
     * The ModifyDate
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfstring|null
     */
    protected ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfstring $Tags = null;
    /**
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo $extendedProperties
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfstring $tags
     */
    public function __construct(?string $creatDate = null, ?string $crmId = null, ?string $crmObjectTypeCode = null, ?string $crmObjectTypeId = null, ?int $crmObjectTypeIndex = null, ?string $crmObjectTypeName = null, ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo $extendedProperties = null, ?string $modifyDate = null, ?string $parentCrmObjectId = null, ?int $processStateIndex = null, ?string $refId = null, ?string $stage = null, ?string $stageId = null, ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfstring $tags = null)
    {
        $this
     ...
     * Set CreatDate value
     * @param string $creatDate
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\StructType\BaseCrmObjectInfo
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo|null
     */
    public function getExtendedProperties(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\StructType\BaseCrmObjectInfo
     */
    public function setExtendedProperties(?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo $extendedProperties = null): self
    {
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfstring|null
     */
    public function getTags(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfstring
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\StructType\BaseCrmObjectInfo
     */
    public function setTags(?\Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\ArrayType\ArrayOfstring $tags = null): self
    {
