...
/**
 * This class stands for SearchContract StructType
 * @subpackage Structs
 */
class SearchContract extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchContract
     * @uses SearchContract::setUserName()
     * @uses SearchContract::setPassword()
     * @uses SearchContract::setTypeKey()
     * @uses SearchContract::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Contract\StructType\SearchContract
     */
