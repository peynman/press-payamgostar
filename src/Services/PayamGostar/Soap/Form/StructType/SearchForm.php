...
/**
 * This class stands for SearchForm StructType
 * @subpackage Structs
 */
class SearchForm extends AbstractStructBase
{
    /**
     * The userName
     ...
     * @uses SearchForm::setUserName()
     * @uses SearchForm::setPassword()
     * @uses SearchForm::setTypeKey()
     * @uses SearchForm::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Form\StructType\SearchForm
     */
