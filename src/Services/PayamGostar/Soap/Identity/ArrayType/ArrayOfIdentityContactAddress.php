...
class ArrayOfIdentityContactAddress extends AbstractStructArrayBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress[]
     */
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress[] $identityContactAddress
     */
    ...
    public static function validateIdentityContactAddressForArrayConstraintFromSetIdentityContactAddress(?array $values = []): string
    {
        ...
        foreach ($values as $arrayOfIdentityContactAddressIdentityContactAddressItem) {
            ...
            if (!$arrayOfIdentityContactAddressIdentityContactAddressItem instanceof \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The IdentityContactAddress property can only contain items of type \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress[] $identityContactAddress
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\ArrayType\ArrayOfIdentityContactAddress
     */
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress|null
     */
    public function current(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress|null
     */
    public function item($index): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress|null
     */
    public function first(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress
    {
        return parent::first();
    }
    /**
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress|null
     */
    public function last(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress
    {
        return parent::last();
    }
    /**
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress|null
     */
    public function offsetGet($offset): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress
    {
     ...
     * @throws InvalidArgumentException
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress $item
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\ArrayType\ArrayOfIdentityContactAddress
     */
    public function add($item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress) {
            throw new InvalidArgumentException(sprintf('The IdentityContactAddress property can only contain items of type \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactAddress, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
