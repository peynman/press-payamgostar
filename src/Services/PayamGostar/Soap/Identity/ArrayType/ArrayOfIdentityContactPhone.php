...
class ArrayOfIdentityContactPhone extends AbstractStructArrayBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone[]
     */
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone[] $identityContactPhone
     */
    ...
    public static function validateIdentityContactPhoneForArrayConstraintFromSetIdentityContactPhone(?array $values = []): string
    {
        ...
        foreach ($values as $arrayOfIdentityContactPhoneIdentityContactPhoneItem) {
            ...
            if (!$arrayOfIdentityContactPhoneIdentityContactPhoneItem instanceof \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The IdentityContactPhone property can only contain items of type \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone[] $identityContactPhone
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\ArrayType\ArrayOfIdentityContactPhone
     */
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone|null
     */
    public function current(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone|null
     */
    public function item($index): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone|null
     */
    public function first(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone
    {
        return parent::first();
    }
    /**
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone|null
     */
    public function last(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone
    {
        return parent::last();
    }
    /**
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone|null
     */
    public function offsetGet($offset): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone
    {
     ...
     * @throws InvalidArgumentException
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone $item
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\ArrayType\ArrayOfIdentityContactPhone
     */
    public function add($item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone) {
            throw new InvalidArgumentException(sprintf('The IdentityContactPhone property can only contain items of type \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\IdentityContactPhone, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
