...
class BaseServiceApi extends AbstractSoapClientBase {
    protected $wsdlRelativePath = '/Services/API/IIdentity_1.wsdl';
    protected $wsdlHostRelativePath = '/Services/API/IIdentity.svc?wsdl';
    ...
    public function __construct(array $wsdlOptions = [])
    {
        ...
        $wsdlOverride[AbstractSoapClientBase::WSDL_CLASSMAP] = \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\ClassMap::get();
