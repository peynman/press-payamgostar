...
/**
 * This class stands for DeleteIdentityById StructType
 * @subpackage Structs
 */
class DeleteIdentityById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for DeleteIdentityById
     * @uses DeleteIdentityById::setUserName()
     * @uses DeleteIdentityById::setPassword()
     * @uses DeleteIdentityById::setIdentityId()
     * @uses DeleteIdentityById::setDeleteOption()
     * @param string $userName
     * @param string $password
     * @param string $identityId
     * @param array|string $deleteOption
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $identityId = null, $deleteOption = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\DeleteIdentityById
     */
    ...
    public static function validateDeleteOptionForListConstraintFromSetDeleteOption(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $deleteIdentityByIdDeleteOptionItem) {
            // validation for constraint: enumeration
            if (!\Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\EnumType\CrmObjectDeleteOption::valueIsValid($deleteIdentityByIdDeleteOptionItem)) {
                $invalidValues[] = is_object($deleteIdentityByIdDeleteOptionItem) ? get_class($deleteIdentityByIdDeleteOptionItem) : sprintf('%s(%s)', gettype($deleteIdentityByIdDeleteOptionItem), var_export($deleteIdentityByIdDeleteOptionItem, true));
            }
        }
        if (!empty($invalidValues)) {
            $message = sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\EnumType\CrmObjectDeleteOption', is_array($invalidValues) ? implode(', ', $invalidValues) : var_export($invalidValues, true), implode(', ', \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\EnumType\CrmObjectDeleteOption::getValidValues()));
        }
        unset($invalidValues);
     ...
     * @uses \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\EnumType\CrmObjectDeleteOption::valueIsValid()
     * @uses \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\EnumType\CrmObjectDeleteOption::getValidValues()
