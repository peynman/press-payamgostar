...
/**
 * This class stands for SearchIdentity StructType
 * @subpackage Structs
 */
class SearchIdentity extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchIdentity
     * @uses SearchIdentity::setUserName()
     * @uses SearchIdentity::setPassword()
     * @uses SearchIdentity::setTypeKey()
     * @uses SearchIdentity::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Identity\StructType\SearchIdentity
     */
