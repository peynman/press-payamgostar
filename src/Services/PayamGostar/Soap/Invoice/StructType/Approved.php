...
/**
 * This class stands for Approved StructType
 * @subpackage Structs
 */
class Approved extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for Approved
     * @uses Approved::setUserName()
     * @uses Approved::setPassword()
     * @uses Approved::setInvoiceId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\Approved
     */
