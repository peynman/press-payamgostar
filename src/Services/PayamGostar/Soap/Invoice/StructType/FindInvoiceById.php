...
/**
 * This class stands for FindInvoiceById StructType
 * @subpackage Structs
 */
class FindInvoiceById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for FindInvoiceById
     * @uses FindInvoiceById::setUserName()
     * @uses FindInvoiceById::setPassword()
     * @uses FindInvoiceById::setInvoiceId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\FindInvoiceById
     */
