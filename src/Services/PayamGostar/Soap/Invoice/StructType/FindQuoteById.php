...
/**
 * This class stands for FindQuoteById StructType
 * @subpackage Structs
 */
class FindQuoteById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for FindQuoteById
     * @uses FindQuoteById::setUserName()
     * @uses FindQuoteById::setPassword()
     * @uses FindQuoteById::setQuoteId()
     * @param string $userName
     * @param string $password
     * @param string $quoteId
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $quoteId = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\FindQuoteById
     */
