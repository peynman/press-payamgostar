...
/**
 * This class stands for GetInvoicesByIdentityId StructType
 * @subpackage Structs
 */
class GetInvoicesByIdentityId extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for GetInvoicesByIdentityId
     * @uses GetInvoicesByIdentityId::setUserName()
     * @uses GetInvoicesByIdentityId::setPassword()
     * @uses GetInvoicesByIdentityId::setIdentityId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\GetInvoicesByIdentityId
     */
