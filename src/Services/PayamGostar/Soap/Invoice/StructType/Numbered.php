...
/**
 * This class stands for Numbered StructType
 * @subpackage Structs
 */
class Numbered extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for Numbered
     * @uses Numbered::setUserName()
     * @uses Numbered::setPassword()
     * @uses Numbered::setInvoiceId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\Numbered
     */
