...
/**
 * This class stands for Rejected StructType
 * @subpackage Structs
 */
class Rejected extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for Rejected
     * @uses Rejected::setUserName()
     * @uses Rejected::setPassword()
     * @uses Rejected::setInvoiceId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\Rejected
     */
