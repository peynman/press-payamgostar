...
/**
 * This class stands for SearchInvoice StructType
 * @subpackage Structs
 */
class SearchInvoice extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchInvoice
     * @uses SearchInvoice::setUserName()
     * @uses SearchInvoice::setPassword()
     * @uses SearchInvoice::setTypeKey()
     * @uses SearchInvoice::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\SearchInvoice
     */
