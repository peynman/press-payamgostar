...
/**
 * This class stands for SearchPurchaseInvoice StructType
 * @subpackage Structs
 */
class SearchPurchaseInvoice extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchPurchaseInvoice
     * @uses SearchPurchaseInvoice::setUserName()
     * @uses SearchPurchaseInvoice::setPassword()
     * @uses SearchPurchaseInvoice::setTypeKey()
     * @uses SearchPurchaseInvoice::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\SearchPurchaseInvoice
     */
