...
/**
 * This class stands for SearchPurchaseQuote StructType
 * @subpackage Structs
 */
class SearchPurchaseQuote extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchPurchaseQuote
     * @uses SearchPurchaseQuote::setUserName()
     * @uses SearchPurchaseQuote::setPassword()
     * @uses SearchPurchaseQuote::setTypeKey()
     * @uses SearchPurchaseQuote::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\SearchPurchaseQuote
     */
