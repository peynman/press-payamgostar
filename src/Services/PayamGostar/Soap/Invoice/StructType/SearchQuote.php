...
class SearchQuote extends AbstractStructBase
{
     ...
     * @uses SearchQuote::setUserName()
     * @uses SearchQuote::setPassword()
     * @uses SearchQuote::setTypeKey()
     * @uses SearchQuote::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\SearchQuote
     */
