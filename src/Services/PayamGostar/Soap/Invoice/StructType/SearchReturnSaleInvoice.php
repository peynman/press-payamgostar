...
/**
 * This class stands for SearchReturnSaleInvoice StructType
 * @subpackage Structs
 */
class SearchReturnSaleInvoice extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchReturnSaleInvoice
     * @uses SearchReturnSaleInvoice::setUserName()
     * @uses SearchReturnSaleInvoice::setPassword()
     * @uses SearchReturnSaleInvoice::setTypeKey()
     * @uses SearchReturnSaleInvoice::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Invoice\StructType\SearchReturnSaleInvoice
     */
