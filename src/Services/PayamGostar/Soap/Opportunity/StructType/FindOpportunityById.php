...
/**
 * This class stands for FindOpportunityById StructType
 * @subpackage Structs
 */
class FindOpportunityById extends AbstractStructBase
{
    /**
     * The username
    ...
    /**
     * Constructor method for FindOpportunityById
     * @uses FindOpportunityById::setUsername()
     * @uses FindOpportunityById::setPassword()
     * @uses FindOpportunityById::setOpportunityId()
     * @param string $username
     * @param string $password
     * @param string $opportunityId
     */
    public function __construct(?string $username = null, ?string $password = null, ?string $opportunityId = null)
    {
        $this
     ...
     * @param string $username
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Opportunity\StructType\FindOpportunityById
     */
