...
/**
 * This class stands for SearchOpportunity StructType
 * @subpackage Structs
 */
class SearchOpportunity extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchOpportunity
     * @uses SearchOpportunity::setUserName()
     * @uses SearchOpportunity::setPassword()
     * @uses SearchOpportunity::setTypeKey()
     * @uses SearchOpportunity::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Opportunity\StructType\SearchOpportunity
     */
