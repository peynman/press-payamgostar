...
/**
 * This class stands for DeleteOrganizationById StructType
 * @subpackage Structs
 */
class DeleteOrganizationById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for DeleteOrganizationById
     * @uses DeleteOrganizationById::setUserName()
     * @uses DeleteOrganizationById::setPassword()
     * @uses DeleteOrganizationById::setOrganizationId()
     * @uses DeleteOrganizationById::setDeleteOption()
     * @param string $userName
     * @param string $password
     * @param string $organizationId
     * @param array|string $deleteOption
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $organizationId = null, $deleteOption = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\StructType\DeleteOrganizationById
     */
    ...
    public static function validateDeleteOptionForListConstraintFromSetDeleteOption(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $deleteOrganizationByIdDeleteOptionItem) {
            // validation for constraint: enumeration
            if (!\Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\EnumType\CrmObjectDeleteOption::valueIsValid($deleteOrganizationByIdDeleteOptionItem)) {
                $invalidValues[] = is_object($deleteOrganizationByIdDeleteOptionItem) ? get_class($deleteOrganizationByIdDeleteOptionItem) : sprintf('%s(%s)', gettype($deleteOrganizationByIdDeleteOptionItem), var_export($deleteOrganizationByIdDeleteOptionItem, true));
            }
        }
        if (!empty($invalidValues)) {
            $message = sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\EnumType\CrmObjectDeleteOption', is_array($invalidValues) ? implode(', ', $invalidValues) : var_export($invalidValues, true), implode(', ', \Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\EnumType\CrmObjectDeleteOption::getValidValues()));
        }
        unset($invalidValues);
     ...
     * @uses \Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\EnumType\CrmObjectDeleteOption::valueIsValid()
     * @uses \Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\EnumType\CrmObjectDeleteOption::getValidValues()
