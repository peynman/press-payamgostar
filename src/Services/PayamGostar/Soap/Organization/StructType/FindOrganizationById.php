...
/**
 * This class stands for FindOrganizationById StructType
 * @subpackage Structs
 */
class FindOrganizationById extends AbstractStructBase
{
    /**
     * The username
    ...
    /**
     * Constructor method for FindOrganizationById
     * @uses FindOrganizationById::setUsername()
     * @uses FindOrganizationById::setPassword()
     * @uses FindOrganizationById::setOrganizationId()
     * @param string $username
     * @param string $password
     * @param string $organizationId
     */
    public function __construct(?string $username = null, ?string $password = null, ?string $organizationId = null)
    {
        $this
     ...
     * @param string $username
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\StructType\FindOrganizationById
     */
