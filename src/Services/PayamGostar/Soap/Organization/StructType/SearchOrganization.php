...
/**
 * This class stands for SearchOrganization StructType
 * @subpackage Structs
 */
class SearchOrganization extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchOrganization
     * @uses SearchOrganization::setUserName()
     * @uses SearchOrganization::setPassword()
     * @uses SearchOrganization::setTypeKey()
     * @uses SearchOrganization::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Organization\StructType\SearchOrganization
     */
