...
class ArrayOfBaseCrmObjectExtendedPropertyInfo extends AbstractStructArrayBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo[]
     */
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo[] $baseCrmObjectExtendedPropertyInfo
     */
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo[]
     */
    ...
    public static function validateBaseCrmObjectExtendedPropertyInfoForArrayConstraintFromSetBaseCrmObjectExtendedPropertyInfo(?array $values = []): string
    {
        ...
        foreach ($values as $arrayOfBaseCrmObjectExtendedPropertyInfoBaseCrmObjectExtendedPropertyInfoItem) {
            ...
            if (!$arrayOfBaseCrmObjectExtendedPropertyInfoBaseCrmObjectExtendedPropertyInfoItem instanceof \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The BaseCrmObjectExtendedPropertyInfo property can only contain items of type \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo[] $baseCrmObjectExtendedPropertyInfo
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo
     */
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo|null
     */
    public function current(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo|null
     */
    public function item($index): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo|null
     */
    public function first(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo
    {
        return parent::first();
    }
    /**
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo|null
     */
    public function last(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo
    {
        return parent::last();
    }
    /**
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo|null
     */
    public function offsetGet($offset): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo
    {
     ...
     * @throws InvalidArgumentException
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo $item
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\ArrayType\ArrayOfBaseCrmObjectExtendedPropertyInfo
     */
    public function add($item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo) {
            throw new InvalidArgumentException(sprintf('The BaseCrmObjectExtendedPropertyInfo property can only contain items of type \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\BaseCrmObjectExtendedPropertyInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
