...
class BaseServiceApi extends AbstractSoapClientBase {
    protected $wsdlRelativePath = '/Services/API/IPayment_1.wsdl';
    protected $wsdlHostRelativePath = '/Services/API/IPayment.svc?wsdl';
    ...
    public function __construct(array $wsdlOptions = [])
    {
        ...
        $wsdlOverride[AbstractSoapClientBase::WSDL_CLASSMAP] = \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\ClassMap::get();
