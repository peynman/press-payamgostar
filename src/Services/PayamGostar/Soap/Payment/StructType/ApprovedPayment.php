...
/**
 * This class stands for ApprovedPayment StructType
 * @subpackage Structs
 */
class ApprovedPayment extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for ApprovedPayment
     * @uses ApprovedPayment::setUserName()
     * @uses ApprovedPayment::setPassword()
     * @uses ApprovedPayment::setPaymentId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\ApprovedPayment
     */
