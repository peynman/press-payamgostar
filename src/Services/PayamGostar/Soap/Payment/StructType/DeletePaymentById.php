...
/**
 * This class stands for DeletePaymentById StructType
 * @subpackage Structs
 */
class DeletePaymentById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for DeletePaymentById
     * @uses DeletePaymentById::setUserName()
     * @uses DeletePaymentById::setPassword()
     * @uses DeletePaymentById::setCrmId()
     * @uses DeletePaymentById::setDeleteOption()
     * @param string $userName
     * @param string $password
     * @param string $crmId
     * @param array|string $deleteOption
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $crmId = null, $deleteOption = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\DeletePaymentById
     */
    ...
    public static function validateDeleteOptionForListConstraintFromSetDeleteOption(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $deletePaymentByIdDeleteOptionItem) {
            // validation for constraint: enumeration
            if (!\Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\EnumType\CrmObjectDeleteOption::valueIsValid($deletePaymentByIdDeleteOptionItem)) {
                $invalidValues[] = is_object($deletePaymentByIdDeleteOptionItem) ? get_class($deletePaymentByIdDeleteOptionItem) : sprintf('%s(%s)', gettype($deletePaymentByIdDeleteOptionItem), var_export($deletePaymentByIdDeleteOptionItem, true));
            }
        }
