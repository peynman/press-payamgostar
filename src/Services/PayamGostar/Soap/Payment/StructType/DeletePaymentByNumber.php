...
/**
 * This class stands for DeletePaymentByNumber StructType
 * @subpackage Structs
 */
class DeletePaymentByNumber extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for DeletePaymentByNumber
     * @uses DeletePaymentByNumber::setUserName()
     * @uses DeletePaymentByNumber::setPassword()
     * @uses DeletePaymentByNumber::setNumber()
     * @uses DeletePaymentByNumber::setDeleteOption()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\DeletePaymentByNumber
     */
    ...
    public static function validateDeleteOptionForListConstraintFromSetDeleteOption(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $deletePaymentByNumberDeleteOptionItem) {
            // validation for constraint: enumeration
            if (!\Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\EnumType\CrmObjectDeleteOption::valueIsValid($deletePaymentByNumberDeleteOptionItem)) {
                $invalidValues[] = is_object($deletePaymentByNumberDeleteOptionItem) ? get_class($deletePaymentByNumberDeleteOptionItem) : sprintf('%s(%s)', gettype($deletePaymentByNumberDeleteOptionItem), var_export($deletePaymentByNumberDeleteOptionItem, true));
            }
        }
