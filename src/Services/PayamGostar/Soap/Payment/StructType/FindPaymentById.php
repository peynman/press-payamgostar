...
/**
 * This class stands for FindPaymentById StructType
 * @subpackage Structs
 */
class FindPaymentById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for FindPaymentById
     * @uses FindPaymentById::setUserName()
     * @uses FindPaymentById::setPassword()
     * @uses FindPaymentById::setPaymentId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\FindPaymentById
     */
