...
/**
 * This class stands for FindPaymentByNumber StructType
 * @subpackage Structs
 */
class FindPaymentByNumber extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for FindPaymentByNumber
     * @uses FindPaymentByNumber::setUserName()
     * @uses FindPaymentByNumber::setPassword()
     * @uses FindPaymentByNumber::setNumber()
     * @uses FindPaymentByNumber::setCrmObjectTypeCode()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\FindPaymentByNumber
     */
