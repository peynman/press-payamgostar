...
/**
 * This class stands for FindReceiptById StructType
 * @subpackage Structs
 */
class FindReceiptById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for FindReceiptById
     * @uses FindReceiptById::setUserName()
     * @uses FindReceiptById::setPassword()
     * @uses FindReceiptById::setReceiptId()
     * @param string $userName
     * @param string $password
     * @param string $receiptId
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $receiptId = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\FindReceiptById
     */
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\FindReceiptById
     */
    public function setReceiptId(?string $receiptId = null): self
    {
        // validation for constraint: string
