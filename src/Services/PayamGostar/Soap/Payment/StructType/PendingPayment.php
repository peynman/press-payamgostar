...
/**
 * This class stands for PendingPayment StructType
 * @subpackage Structs
 */
class PendingPayment extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for PendingPayment
     * @uses PendingPayment::setUserName()
     * @uses PendingPayment::setPassword()
     * @uses PendingPayment::setPaymentId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\PendingPayment
     */
