...
/**
 * This class stands for RejectedPayment StructType
 * @subpackage Structs
 */
class RejectedPayment extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for RejectedPayment
     * @uses RejectedPayment::setUserName()
     * @uses RejectedPayment::setPassword()
     * @uses RejectedPayment::setPaymentId()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\RejectedPayment
     */
