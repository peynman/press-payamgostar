...
/**
 * This class stands for SearchReceipt StructType
 * @subpackage Structs
 */
class SearchReceipt extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchReceipt
     * @uses SearchReceipt::setUserName()
     * @uses SearchReceipt::setPassword()
     * @uses SearchReceipt::setQuery()
     * @uses SearchReceipt::setCrmObjectTypeCode()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Payment\StructType\SearchReceipt
     */
