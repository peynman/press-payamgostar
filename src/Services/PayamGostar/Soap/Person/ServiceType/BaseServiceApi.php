...
class BaseServiceApi extends AbstractSoapClientBase {
    protected $wsdlRelativePath = '/Services/API/IPerson_1.wsdl';
    protected $wsdlHostRelativePath = '/Services/API/IPerson.svc?wsdl';
    ...
    public function __construct(array $wsdlOptions = [])
    {
        ...
        $wsdlOverride[AbstractSoapClientBase::WSDL_CLASSMAP] = \Larapress\PayamGostar\Services\PayamGostar\Soap\Person\ClassMap::get();
