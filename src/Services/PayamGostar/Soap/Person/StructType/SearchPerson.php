...
/**
 * This class stands for SearchPerson StructType
 * @subpackage Structs
 */
class SearchPerson extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchPerson
     * @uses SearchPerson::setUserName()
     * @uses SearchPerson::setPassword()
     * @uses SearchPerson::setTypeKey()
     * @uses SearchPerson::setQuery()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Person\StructType\SearchPerson
     */
