...
/**
 * This class stands for DeletePhoneLogById StructType
 * @subpackage Structs
 */
class DeletePhoneLogById extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for DeletePhoneLogById
     * @uses DeletePhoneLogById::setUserName()
     * @uses DeletePhoneLogById::setPassword()
     * @uses DeletePhoneLogById::setPhoneLogId()
     * @uses DeletePhoneLogById::setDeleteOption()
     * @param string $userName
     * @param string $password
     * @param string $phoneLogId
     * @param array|string $deleteOption
     */
    public function __construct(?string $userName = null, ?string $password = null, ?string $phoneLogId = null, $deleteOption = null)
    {
        $this
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\PhoneLog\StructType\DeletePhoneLogById
     */
    ...
    public static function validateDeleteOptionForListConstraintFromSetDeleteOption(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $deletePhoneLogByIdDeleteOptionItem) {
            // validation for constraint: enumeration
            if (!\Larapress\PayamGostar\Services\PayamGostar\Soap\PhoneLog\EnumType\CrmObjectDeleteOption::valueIsValid($deletePhoneLogByIdDeleteOptionItem)) {
                $invalidValues[] = is_object($deletePhoneLogByIdDeleteOptionItem) ? get_class($deletePhoneLogByIdDeleteOptionItem) : sprintf('%s(%s)', gettype($deletePhoneLogByIdDeleteOptionItem), var_export($deletePhoneLogByIdDeleteOptionItem, true));
            }
        }
        if (!empty($invalidValues)) {
            $message = sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Larapress\PayamGostar\Services\PayamGostar\Soap\PhoneLog\EnumType\CrmObjectDeleteOption', is_array($invalidValues) ? implode(', ', $invalidValues) : var_export($invalidValues, true), implode(', ', \Larapress\PayamGostar\Services\PayamGostar\Soap\PhoneLog\EnumType\CrmObjectDeleteOption::getValidValues()));
        }
        unset($invalidValues);
     ...
     * @uses \Larapress\PayamGostar\Services\PayamGostar\Soap\PhoneLog\EnumType\CrmObjectDeleteOption::valueIsValid()
     * @uses \Larapress\PayamGostar\Services\PayamGostar\Soap\PhoneLog\EnumType\CrmObjectDeleteOption::getValidValues()
