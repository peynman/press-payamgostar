...
/**
 * This class stands for SearchPhoneLog StructType
 * @subpackage Structs
 */
class SearchPhoneLog extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for SearchPhoneLog
     * @uses SearchPhoneLog::setUserName()
     * @uses SearchPhoneLog::setPassword()
     * @uses SearchPhoneLog::setQuery()
     * @uses SearchPhoneLog::setTypeKey()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\PhoneLog\StructType\SearchPhoneLog
     */
