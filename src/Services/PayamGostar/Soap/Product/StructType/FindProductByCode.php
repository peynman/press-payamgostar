...
/**
 * This class stands for FindProductByCode StructType
 * @subpackage Structs
 */
class FindProductByCode extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for FindProductByCode
     * @uses FindProductByCode::setUserName()
     * @uses FindProductByCode::setPassword()
     * @uses FindProductByCode::setCode()
     * @uses FindProductByCode::setGroupName()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Product\StructType\FindProductByCode
     */
