...
class PriceListInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Larapress\PayamGostar\Services\PayamGostar\Soap\Product\ArrayType\ArrayOfPriceListProductInfo|null
     */
    protected ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Product\ArrayType\ArrayOfPriceListProductInfo $PriceListProducts = null;
    /**
     ...
     * @param string $name
     * @param \Larapress\PayamGostar\Services\PayamGostar\Soap\Product\ArrayType\ArrayOfPriceListProductInfo $priceListProducts
     */
    public function __construct(?string $invoiceType = null, ?string $name = null, ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Product\ArrayType\ArrayOfPriceListProductInfo $priceListProducts = null)
    {
        $this
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Product\ArrayType\ArrayOfPriceListProductInfo|null
     */
    public function getPriceListProducts(): ?\Larapress\PayamGostar\Services\PayamGostar\Soap\Product\ArrayType\ArrayOfPriceListProductInfo
    {
     ...
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Product\StructType\PriceListInfo
     */
    public function setPriceListProducts(?\Larapress\PayamGostar\Services\PayamGostar\Soap\Product\ArrayType\ArrayOfPriceListProductInfo $priceListProducts = null): self
    {
