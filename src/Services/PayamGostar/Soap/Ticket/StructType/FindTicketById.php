...
/**
 * This class stands for FindTicketById StructType
 * @subpackage Structs
 */
class FindTicketById extends AbstractStructBase
{
    /**
     * The username
    ...
    /**
     * Constructor method for FindTicketById
     * @uses FindTicketById::setUsername()
     * @uses FindTicketById::setPassword()
     * @uses FindTicketById::setTicketId()
     ...
     * @param string $username
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Ticket\StructType\FindTicketById
     */
