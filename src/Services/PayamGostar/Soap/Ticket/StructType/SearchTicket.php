...
/**
 * This class stands for SearchTicket StructType
 * @subpackage Structs
 */
class SearchTicket extends AbstractStructBase
{
    /**
     * The username
    ...
    /**
     * Constructor method for SearchTicket
     * @uses SearchTicket::setUsername()
     * @uses SearchTicket::setPassword()
     * @uses SearchTicket::setTypeKey()
     * @uses SearchTicket::setQuery()
     ...
     * @param string $username
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\Ticket\StructType\SearchTicket
     */
