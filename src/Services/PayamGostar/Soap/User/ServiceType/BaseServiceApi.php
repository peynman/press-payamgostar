...
class BaseServiceApi extends AbstractSoapClientBase {
    protected $wsdlRelativePath = '/Services/API/IUser_1.wsdl';
    protected $wsdlHostRelativePath = '/Services/API/IUser.svc?wsdl';
    ...
    public function __construct(array $wsdlOptions = [])
    {
        ...
        $wsdlOverride[AbstractSoapClientBase::WSDL_CLASSMAP] = \Larapress\PayamGostar\Services\PayamGostar\Soap\User\ClassMap::get();
