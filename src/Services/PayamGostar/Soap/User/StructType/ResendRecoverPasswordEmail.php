...
/**
 * This class stands for ResendRecoverPasswordEmail StructType
 * @subpackage Structs
 */
class ResendRecoverPasswordEmail extends AbstractStructBase
{
    /**
     * The userName
    ...
    /**
     * Constructor method for ResendRecoverPasswordEmail
     * @uses ResendRecoverPasswordEmail::setUserName()
     * @uses ResendRecoverPasswordEmail::setPassword()
     * @uses ResendRecoverPasswordEmail::setTargetUsername()
     ...
     * @param string $userName
     * @return \Larapress\PayamGostar\Services\PayamGostar\Soap\User\StructType\ResendRecoverPasswordEmail
     */
